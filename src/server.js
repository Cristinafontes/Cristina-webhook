...
// === Envio como TEXTO SIMPLES (sem botões) + marca fase do template ===
const lembrete = 
  `Olá, estou passando para lembrar da sua consulta no dia ${dataHoraPt} com a Dra. Jenifer Bottino.\n` +
  `\n` +
  `Deseja:\n` +
  `1 - CONFIRMAR\n` +
  `2 - CANCELAR`;

await sendText({ to: phoneDigits, text: lembrete });

// 🔒 Marca fase "reminder_template" por 48h para isolar 1/2/confirmar/cancelar
try {
